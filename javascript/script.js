...
const fechaObjetivo = new Date("november 21, 2026 20:30:00").getTime();
...
// --------------------------- playlist --------------------------------
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    const phoneNumber1 = '543815270194'; // Número para el primer botón
...
document.addEventListener('DOMContentLoaded', function() {
    // Definir los números de teléfono
    const recipientNumber1 = '543815270194'; // Número para el primer botón
    const recipientNumber2 = '543794009242'; // Número para el segundo botón
