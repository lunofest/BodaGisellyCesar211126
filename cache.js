function cargarRecursos(recursos, version) {
    recursos.forEach(function (recurso) {
        var urlActualizada = recurso.includes('?v=') ? recurso : recurso + '?v=' + version;
        var elementos = document.querySelectorAll('[href="' + recurso + '"], [src="' + recurso + '"]');
        
        elementos.forEach(function (elemento) {
            // Si el elemento ya tiene la URL actualizada, no hacemos nada
            if (elemento.getAttribute('src') === urlActualizada || elemento.getAttribute('href') === urlActualizada) {
                return;
            }
...
function forzarActualizacionCache() {
    var recursos = [
        'estilos/normalize.css?v27',
        'estilos/styles.css?v27',
        'estilos/mediaQueries.css?v27',
        'javascript/script.js?v27',
        // Add other URLs of your resources here
    ];
    var version = 'v27'; // Use a static or manually managed version
